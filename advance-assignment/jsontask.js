...
// console.log("🚀 ~ file: .json-task.js:22 ~ city1:", city1);
...
function city(params) {
  ...
  // console.log("🚀 ~ file: .json-task.js:31 ~ cityname ~ cityname:", cityname)

  let cityshow = cityname.filter((e) => {
    return e.length > 15;
  });
  // console.log("🚀 ~ file: .json-task.js:36 ~ cityshow ~ cityshow:", cityshow)
}
city();
